...
from M02 import mo2
from M14 import m14
from M03_world import mo3
from M11_world import m11
...
class Master_Main():
  def __init__(self):
    ...
    self.ev3 = EV3Brick()
    self.missions = [["M11", m11(), "IMAGES/missions/M08"], ["M03", mo3(), "IMAGES/missions/M03"], ["M06", mo6(), "IMAGES/missions/M06"], ["M08", mo8(), "IMAGES/missions/M08"], ["M14", m14(), "IMAGES/missions/M14"], ["M02", mo2(), "IMAGES/missions/M02"], ["M10", m10(), "IMAGES/missions/M10"]]
